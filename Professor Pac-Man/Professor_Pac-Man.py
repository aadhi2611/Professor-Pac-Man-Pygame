...
#
# Required files:
# - questions.txt, save_file.txt
# - pacmanR.png, pacmanR_C.png, strawberry.jpg, scoreLine.png, scoreBoard.jpg, profPacMan.jpg
# - title.png, gameover.png, completed.png
# - check.png, wrong.png
...
def main():
    ...
    PACMAN = pygame.image.load("pacmanR.png")
    PACMAN_C = pygame.image.load("pacmanR_C.png")
    PacX = 150
    PacY = 155
    PacSpeed = 5
    P_IMAGE = PACMAN
    ...
    while True:
        ...
        # Score Line
        lineRect = pygame.image.load("scoreLine.png").get_rect()
        lineRect.bottomleft = (150, 180)
        SCREEN.blit(pygame.image.load("scoreLine.png"), lineRect)
        ...
        strawRect = pygame.image.load("strawberry.jpg").get_rect()
        strawRect.bottomleft = (SCREEN_WIDTH-170, 110)
        SCREEN.blit(pygame.image.load("strawberry.jpg"), strawRect)

        # Image that shows score
        scoreRect = pygame.image.load("scoreBoard.jpg").get_rect()
        scoreRect.bottomleft = (SCREEN_WIDTH/2, 150)
        SCREEN.blit(pygame.image.load("scoreBoard.jpg"), scoreRect)
        ...
        numberRect = pygame.image.load("profPacMan.jpg").get_rect()
        numberRect.bottomleft = (300, 150)
        SCREEN.blit(pygame.image.load("profPacMan.jpg"), numberRect)
        ...
        if timeUp == True:
            wrongRect = pygame.image.load("wrong.png").get_rect()
            wrongRect.center = (SCREEN_WIDTH/2+150, SCREEN_HEIGHT/2+100)
            SCREEN.blit(pygame.image.load("wrong.png"), wrongRect)
        ...
        if questionFinished and LIVES > 0:
            if index == num-6:  # if last level
                ...
                checkRect = pygame.image.load("check.png").get_rect()
                checkRect.center = (SCREEN_WIDTH/2+150, SCREEN_HEIGHT/2+100)
                SCREEN.blit(pygame.image.load("check.png"), checkRect)
                pygame.display.update()
                index += 7
                if PacX < 213:
                    SCORE += 800
